...
export const STAGES = [
  {
    ...
    grip: 1,
    drag: 0.014,
    terrain: { amp: 3.4, wave: 19, rough: 0.8, bumps: 0.7, ramp: 0.8 },
    theme: {
      sky0: "#7fd2ff",
      sky1: "#cdeeff",
      sun: "#fff3c4",
  ...
  },
  {
    ...
    grip: 0.86,
    drag: 0.013,
    terrain: { amp: 4.4, wave: 26, rough: 0.85, bumps: 0.5, ramp: 0.95 },
    theme: {
      sky0: "#ffb774",
      sky1: "#ffe7bd",
      sun: "#fff0b8",
  ...
  },
  {
    ...
    grip: 0.62,
    drag: 0.012,
    terrain: { amp: 4.1, wave: 18, rough: 1, bumps: 0.9, ramp: 0.85 },
    theme: {
      sky0: "#3f6f9e",
      sky1: "#bfe2f5",
      sun: "#eaf6ff",
  ...
  },
  {
    ...
    grip: 1.15,
    drag: 0.011,
    terrain: { amp: 3.8, wave: 30, rough: 0.45, bumps: 0.3, ramp: 1 },
    theme: {
      sky0: "#2a3552",
      sky1: "#8ea2d0",
      sun: "#ffd9a0",
  ...
  },
  {
    ...
    grip: 0.7,
    drag: 0.003,
    terrain: { amp: 4.5, wave: 24, rough: 0.9, bumps: 0.7, ramp: 0.9 },
    theme: {
      sky0: "#05060f",
      sky1: "#161a33",
      sun: "#dfe7ff",
